 ...
 * @since 1.0
 */
public class ButtonObservableTextOn extends AbstractAndroidObservableValue {
	 ...
	 *            the button
	 */
	public ButtonObservableTextOn(ToggleButton button) {
		super(button);
		this.button = button;
	}
	 ...
	 * @param button
	 */
	public ButtonObservableTextOn(Realm realm, ToggleButton button) {
		super(realm, button);
		this.button = button;
	}
